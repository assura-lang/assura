//! Close-match suggestions for small closed vocabularies.
...
pub fn suggest_error_code(code: &str) -> Option<&'static str> {
...
pub fn unknown_error_code_message(code: &str) -> String {
