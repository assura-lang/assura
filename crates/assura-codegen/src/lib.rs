...
pub use contract::{collect_contract_params, extract_input_params};
pub use expr::expr_to_rust_static;
pub use types_gen::{map_type_token, map_type_tokens};
...
/// Lint suppression header prepended to every generated `.rs` file.
const GENERATED_ALLOW_ATTRS: &str = "#![allow(dead_code, unused_variables, unused_imports, unused_parens, non_camel_case_types, unreachable_code)]\n\n";

/// Comment header prepended to every generated `.rs` file.
