...
int/bool arith, if/else/match, multi-let (incl. `let y = if/match …; y + n` and if-on-right / both-if
binaries via if/match-over-binary distribute), abs/min/max/clamp/signum/saturating (incl. u64 via synthetic max)/
