...
#   2) encoded Rust body (int/bool/&&/||, if/else/match, multi-let, abs/min/max/clamp/signum/saturating/abs_diff, is_multiple_of, into/as, PartialOrd/borrow/deref/pow/default)
