...
| `start-cleanup-pr-ci.sh` | App-actor approve of stub `action_required` runs on a GITHUB_TOKEN cleanup PR | Called from `release.yml` `cleanup-release-notes` (#1517 / #1520) |
